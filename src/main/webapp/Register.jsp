...
<img src="././assets/images/register-artist.svg">
	...
	<form id="cardform" method="post" action="AddArtistServlet">
		<input type="text" class="input-info" placeholder="Username"
			...
			title="Please enter only letters"> <input type="email"
			class="input-info" placeholder="Email" name="email" required
			...
			for="language">Known Languages</label> <input type=text class="input-info"
			placeholder="Languages" name="language"> <br> <br>
