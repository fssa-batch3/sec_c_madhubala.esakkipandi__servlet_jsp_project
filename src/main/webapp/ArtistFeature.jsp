...
<body>
	<div class="menu-bar">
		...
		<ul class="main">
			...
			<li id="login-btn"><a href="../Login/login.html"> <i
					class="fa-solid fa-user"></i>login
			</a></li>
			<li id="profile-btn" style="display: none;"><a
				href="../profile_of_user.html"><img
	...
	<div class="upper-form">
		<div class="formm">
			...
			<%
			String GET_ALL_ARTIST = request.getContextPath() + "/getArtistServlet";
			%>


			<a href="<%=GET_ALL_ARTIST%>">

				<button class="book_now">See Artists</button>
			</a>
